      ...
      {!props?.isMenuOpen ? (
        <div className="max-w-screen-xl mx-auto p-0 md:p-4">
          ...
          <div className="flex flex-wrap md:flex-nowrap justify-between space-y-3 md:space-y-0 md:space-x-2">
            ...
            {/* <button
              type="submit"
              className="flex items-center justify-center p-3 border-2  border-[#221f1f] hover:bg-[#221f1f] rounded-sm group transition ease-in-out w-full md:w-fit space-x-6"
            >
              <svg
              ...
              .map((product, index) => {
                return (
                  <div className="flex flex-wrap" key={index}>
                    ...
                    <div
                      className={`w-full flex-grow lg:w-1/2 border-b-2 border-l-8 pt-6 pb-4 lg:py-4 relative border- ${
                        product.type == "Buy"
                          ? "border-l-green-500"
                          : "border-l-red-500"
