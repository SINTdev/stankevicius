  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-full text-left text-xl _font-bold leading-relaxed tracking-normal text-black">
        We aim to increase access to our medicines for underserved populations
        around the world, and follow high standards of ethical behavior wherever
        we operate. In 2022, we pledged investment for research into new
        medicines for neglected tropical diseases while advancing partnerships
        to enhance cardiovascular and cancer care for patients across the world.
      </div>
      <div className="py-3"></div>{" "}
      <div className="flex flex-col my-3">
        <img src="https://www.reporting.novartis.com/2022/_assets/gallery/47-strengthen-foundations.jpg" />
        <span className="text-xs mt-1.5 tracking-wider">
          Members of an indigenous community near Santa Cecilia, Colombia, where
          visceral leishmaniasis, a neglected tropical disease spread by sand
          flies, is endemic. With the nearest hospital hours away by car, access
          to healthcare is limited to irregular visits by a nurse from a nearby
          village.
        </span>
      </div>
      <div className="py-3"></div>
      ...
      <div className="bg-[#F4F4F4] px-4 py-10 flex flex-row space-x-4 justify-center">
        ...
        <div className="flex flex-col w-2/5 mt-16">
          ...
          <div className="w-full text-left leading-relaxed tracking-wide text-base text-black">
            pharmaceutical company to contribute an innovative medicine to the
            ATOM coalition, a public-private partnership aimed at building a new
            sustainable model for access to cancer medicines.
          </div>
        </div>
      </div>
      <div className="py-3"></div>{" "}
